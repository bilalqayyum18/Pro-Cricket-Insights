...
if page == "Match Center":
    ...
    if not sf_balls.empty:
        ...
        fig_fan = px.bar(fan.sort_values('pts', ascending=False).head(11), x='pts', y='p_name', orientation='h', title="Fantasy Impact Ranking", template="plotly_dark", labels={"p_name: "Player Name"})
